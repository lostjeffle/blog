...
- payload buffer 存储需要发送的数据，header buffer 的 ring_ent_in_out.payload_sz 描述了 payload buffer 中有效数据的长度
...
![fuse_uring_in_userspace](media/17324235631149/fuse_uring_in_userspace.jpg)
